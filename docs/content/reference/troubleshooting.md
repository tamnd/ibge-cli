...
Most of these come down to network reality or how ibge serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ibge rate-limits like any public site. ibge already paces
...
Where a surface is gated, ibge reads a cookie or token you supply
...
`ibge`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ibge actually did
